...
public enum Holiday {
	...
	//Nothing in Sept
	HALLOWEEN,              //2nd week of October through November 1st
	//Nothing in Nov
	PD_BIRTHDAY,            //Dec 1st to Dec 7th                                    (7 days)
	WINTER_HOLIDAYS,        //3rd week of December through 1st week of January
	NEW_YEARS;              //Dec 27th to Jan 2nd                                   (7 days)

	//no caching here (unlike upstream) - this fork's PixelScene has no invalidation hook to
	//clear a cache against, so we just recompute on every call instead
	...
	public static Holiday getHolidayForDate(GregorianCalendar cal){
		...
		//Winter Holidays - 3rd week of December through 1st week of January
		if ((cal.get(Calendar.MONTH) == Calendar.DECEMBER
